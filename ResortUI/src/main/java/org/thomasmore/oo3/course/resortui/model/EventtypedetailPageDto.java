...
public class EventtypedetailPageDto {
    ...
    private EventtypedetailDetailDto detail = new EventtypedetailDetailDto();
    ...
    public EventtypedetailDetailDto getDetail() {
        return detail;
    }

    public void setDetail(EventtypedetailDetailDto detail) {
        this.detail = detail;
    }
